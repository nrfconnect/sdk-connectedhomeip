...
function(nrfconnect_create_factory_data_sysbuild factory_data_target script_path schema_path output_path)
  # Get required Kconfig values from the main application
  ...
  # Get partition info from device tree (available at sysbuild level from main app)
  ...
  # Execute script to create factory data files
  ...
  add_custom_command(
    ...
    COMMENT "Generating Matter Factory Data..."
  )
...
# Main entry point for factory data generation at sysbuild level
...
nrfconnect_create_factory_data_sysbuild(factory_data
                                        ${FACTORY_DATA_SCRIPT_PATH}
                                        ${FACTORY_DATA_SCHEMA_PATH}
                                        ${OUTPUT_FILE_PATH}
)

# Make factory_data depend on main image being configured (for Kconfig values)
add_dependencies(factory_data ${DEFAULT_IMAGE})
