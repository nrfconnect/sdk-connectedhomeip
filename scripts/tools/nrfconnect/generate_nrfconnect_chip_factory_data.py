...
def main():
    ...
    if args.generate_onboarding and no_qrcode_module:
        log.error(("Requested generation of onboarding codes, but the qrcode module is not installed. \n"
                  "Install only the module by invoking: pip3 install qrcode \n"
