...
#define CHIP_DEVICE_CONFIG_ENABLE_THREAD CONFIG_OPENTHREAD
#else
...
#define CHIP_DEVICE_CONFIG_ENABLE_NFC_BASED_COMMISSIONING CONFIG_CHIP_NFC_BASED_COMMISSIONING
#else
...
#endif // CONFIG_CHIP_NFC_ONBOARDING_PAYLOAD
#endif // CHIP_DEVICE_CONFIG_ENABLE_NFC_ONBOARDING_PAYLOAD

#if CHIP_DEVICE_CONFIG_ENABLE_NFC_ONBOARDING_PAYLOAD && CHIP_DEVICE_CONFIG_ENABLE_NFC_BASED_COMMISSIONING
#error                                                                                                                             \
    "CHIP_DEVICE_CONFIG_ENABLE_NFC_ONBOARDING_PAYLOAD and CHIP_DEVICE_CONFIG_ENABLE_NFC_BASED_COMMISSIONING are mutually exclusive on nRF Connect SDK."
#endif
...
#ifdef CONFIG_CHIP_ICD_SIT_POLLING_INTERVAL
#define CHIP_DEVICE_CONFIG_ICD_SIT_POLLING_INTERVAL chip::System::Clock::Milliseconds32(CONFIG_CHIP_ICD_SIT_POLLING_INTERVAL)
#endif // CONFIG_CHIP_ICD_SIT_POLLING_INTERVAL
