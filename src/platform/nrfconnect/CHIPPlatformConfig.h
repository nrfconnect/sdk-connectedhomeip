...
#define CHIP_CONFIG_LOG_MODULE_NotSpecified_DETAIL 0
#define CHIP_CONFIG_LOG_MODULE_NotSpecified_PROGRESS 0
#define CHIP_CONFIG_LOG_MODULE_Inet_DETAIL 0
#define CHIP_CONFIG_LOG_MODULE_Inet_PROGRESS 0
#define CHIP_CONFIG_LOG_MODULE_Ble_DETAIL 0
#define CHIP_CONFIG_LOG_MODULE_Ble_PROGRESS 0
#define CHIP_CONFIG_LOG_MODULE_MessageLayer_DETAIL 0
#define CHIP_CONFIG_LOG_MODULE_MessageLayer_PROGRESS 0
#define CHIP_CONFIG_LOG_MODULE_SecurityManager_DETAIL 0
#define CHIP_CONFIG_LOG_MODULE_SecurityManager_PROGRESS 0
#define CHIP_CONFIG_LOG_MODULE_ExchangeManager_DETAIL 0
#define CHIP_CONFIG_LOG_MODULE_ExchangeManager_PROGRESS 1
#define CHIP_CONFIG_LOG_MODULE_TLV_DETAIL 0
#define CHIP_CONFIG_LOG_MODULE_TLV_PROGRESS 0
#define CHIP_CONFIG_LOG_MODULE_ASN1_DETAIL 0
#define CHIP_CONFIG_LOG_MODULE_ASN1_PROGRESS 0
#define CHIP_CONFIG_LOG_MODULE_Crypto_DETAIL 1
#define CHIP_CONFIG_LOG_MODULE_Crypto_PROGRESS 1
#define CHIP_CONFIG_LOG_MODULE_Controller_DETAIL 0
#define CHIP_CONFIG_LOG_MODULE_Controller_PROGRESS 0
#define CHIP_CONFIG_LOG_MODULE_Alarm_DETAIL 0
#define CHIP_CONFIG_LOG_MODULE_Alarm_PROGRESS 0
...
#define CHIP_CONFIG_LOG_MODULE_DataManagement_PROGRESS 1
#define CHIP_CONFIG_LOG_MODULE_DeviceControl_DETAIL 0
#define CHIP_CONFIG_LOG_MODULE_DeviceControl_PROGRESS 0
#define CHIP_CONFIG_LOG_MODULE_DeviceDescription_DETAIL 0
#define CHIP_CONFIG_LOG_MODULE_DeviceDescription_PROGRESS 0
#define CHIP_CONFIG_LOG_MODULE_Echo_DETAIL 0
#define CHIP_CONFIG_LOG_MODULE_Echo_PROGRESS 0
#define CHIP_CONFIG_LOG_MODULE_FabricProvisioning_DETAIL 1
#define CHIP_CONFIG_LOG_MODULE_FabricProvisioning_PROGRESS 1
#define CHIP_CONFIG_LOG_MODULE_NetworkProvisioning_DETAIL 0
#define CHIP_CONFIG_LOG_MODULE_NetworkProvisioning_PROGRESS 0
#define CHIP_CONFIG_LOG_MODULE_ServiceDiscovery_DETAIL 0
#define CHIP_CONFIG_LOG_MODULE_ServiceDiscovery_PROGRESS 0
#define CHIP_CONFIG_LOG_MODULE_ServiceProvisioning_DETAIL 0
#define CHIP_CONFIG_LOG_MODULE_ServiceProvisioning_PROGRESS 0
#define CHIP_CONFIG_LOG_MODULE_SoftwareUpdate_DETAIL 0
#define CHIP_CONFIG_LOG_MODULE_SoftwareUpdate_PROGRESS 1
#define CHIP_CONFIG_LOG_MODULE_FailSafe_DETAIL 0
#define CHIP_CONFIG_LOG_MODULE_FailSafe_PROGRESS 0
#define CHIP_CONFIG_LOG_MODULE_TimeService_DETAIL 0
#define CHIP_CONFIG_LOG_MODULE_TimeService_PROGRESS 0
#define CHIP_CONFIG_LOG_MODULE_Heartbeat_DETAIL 0
#define CHIP_CONFIG_LOG_MODULE_Heartbeat_PROGRESS 0
...
#define CHIP_CONFIG_LOG_MODULE_chipTool_DETAIL 0
#define CHIP_CONFIG_LOG_MODULE_chipTool_PROGRESS 0
#define CHIP_CONFIG_LOG_MODULE_Zcl_DETAIL 1
#define CHIP_CONFIG_LOG_MODULE_Zcl_PROGRESS 1
#define CHIP_CONFIG_LOG_MODULE_Shell_DETAIL 0
#define CHIP_CONFIG_LOG_MODULE_Shell_PROGRESS 0
...
#define CHIP_CONFIG_LOG_MODULE_AppServer_PROGRESS 1
#define CHIP_CONFIG_LOG_MODULE_Discovery_DETAIL 0
#define CHIP_CONFIG_LOG_MODULE_Discovery_PROGRESS 1
#define CHIP_CONFIG_LOG_MODULE_InteractionModel_DETAIL 1
#define CHIP_CONFIG_LOG_MODULE_InteractionModel_PROGRESS 1
#define CHIP_CONFIG_LOG_MODULE_Test_DETAIL 0
#define CHIP_CONFIG_LOG_MODULE_Test_PROGRESS 0
#define CHIP_CONFIG_LOG_MODULE_OperationalSessionSetup_DETAIL 0
#define CHIP_CONFIG_LOG_MODULE_OperationalSessionSetup_PROGRESS 0
#define CHIP_CONFIG_LOG_MODULE_Automation_DETAIL 0
#define CHIP_CONFIG_LOG_MODULE_Automation_PROGRESS 0
#define CHIP_CONFIG_LOG_MODULE_CASESessionManager_DETAIL 1
#define CHIP_CONFIG_LOG_MODULE_CASESessionManager_PROGRESS 1
#define CHIP_CONFIG_LOG_MODULE_ICD_DETAIL 1
#define CHIP_CONFIG_LOG_MODULE_ICD_PROGRESS 1
#endif
