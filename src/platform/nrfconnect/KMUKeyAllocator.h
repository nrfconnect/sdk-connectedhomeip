...
#define KMU_MATTER_SLOTS_PER_ICD_KEY 2 // ICD KEY means a pair of AES and HMAC keys per fabric
...
#define CHIP_KMU_MAX_FABRICS ((CONFIG_CHIP_KMU_SLOT_RANGE_END - CONFIG_CHIP_KMU_SLOT_RANGE_START) / KMU_MATTER_SLOTS_PER_NOC_KEY)
#endif // CONFIG_CHIP_ICD_CHECK_IN_SUPPORT

// Define how many slots are available for Matter.
#define KMU_MATTER_SLOT_COUNT (CONFIG_CHIP_KMU_SLOT_RANGE_END - CONFIG_CHIP_KMU_SLOT_RANGE_START)
...
#define KMU_MATTER_ICD_SLOT_START                                                                                                  \
    PSA_KEY_HANDLE_FROM_CRACEN_KMU_SLOT(CRACEN_KMU_KEY_USAGE_SCHEME_RAW,                                                           \
                                        (CONFIG_CHIP_KMU_SLOT_RANGE_START + KMU_MATTER_NOC_SLOT_COUNT))
